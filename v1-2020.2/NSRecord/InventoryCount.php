<?php
class NSRecord_InventoryCount extends RequestAbstract
{
   /**
    * [inventoryCount]
    ...
    */
    public static $schema = [
        ...
        'externalId',              // string
        'id',                      // string
        'item',                    // InventoryCountItemCollection
        ...
        'selStatus',               // string enum(A, B, C, D)
        'status',                  // string enum(A, B, C, D, Y)
        'statusKey',               // string
    ...
    * @return string json:inventoryCount - Retrieved record 
    * @meta [default] nsError - Error response 
    */
