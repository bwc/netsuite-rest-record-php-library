...
class NSRecord_BillingRateCard extends RequestAbstract
{
    ...
    */
    public static $schema = [
        ...
        'name',                    // string
        'ratecardpricing',         // BillingRateCardRatecardpricingCollection
        'ratecardpricingmulti',    // BillingRateCardRatecardpricingmulti
        'ratecardversion',         // BillingRateCardRatecardversionCollection
    ...
    * @return string json:billingRateCard - Retrieved record
    * @response [default] nsError - Error response
    */
