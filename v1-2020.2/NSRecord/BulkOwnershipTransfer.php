<?php
class NSRecord_BulkOwnershipTransfer extends RequestAbstract
{
   /**
    ...
    */
    public static $schema = [
        ...
        'incoterm',                // NsResource
        'items',                   // BulkOwnershipTransferItemsCollection
    ...
    * @return string json:bulkOwnershipTransfer - Retrieved record 
    * @meta [default] nsError - Error response 
    */
