<?php
class NSRecord_IntercompanyTransferOrder extends RequestAbstract
{
   /**
    ...
    */
    public static $schema = [
        'accountingBookDetail',    // IntercompanyTransferOrderAccountingBookDetailCollection
        ...
        'item',                    // IntercompanyTransferOrderItemCollection
        ...
        'shipState',               // string
        'shipZip',                 // string
        'shippingAddress',         // IntercompanyTransferOrderShippingAddress
    ...
    * @return string json:intercompanyTransferOrder - Retrieved record
    * @response [default] nsError - Error response
    */
