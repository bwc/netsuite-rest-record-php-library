<?php
class NSRecord_FairValuePrice extends RequestAbstract
{
   /**
    * [fairValuePrice]
    ...
    */
    public static $schema = [
        ...
        'fairValueRangePolicy',    // string enum(HIGH, LOW, BOUNDARY, FAIRVALUE)
        'highValue',               // float
        ...
        'sourceType',              // string enum(SUBSCRIPTION_LINE, TRANSACTION_LINE, PROJECT_REVENUE_RULE, THIRD_PARTY)
        'startDate',               // string
    ...
    * @return string json:fairValuePrice - Retrieved record 
    * @meta [default] nsError - Error response 
    */
