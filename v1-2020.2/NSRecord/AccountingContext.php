<?php
class NSRecord_AccountingContext extends RequestAbstract
{
   /**
    * [accountingContext]
    ...
    */
    public static $schema = [
        ...
        'translations',            // AccountingContextTranslationsCollection
    ];    
    ...
    * @return string json:accountingContext - Retrieved record 
    * @meta [default] nsError - Error response 
    */
