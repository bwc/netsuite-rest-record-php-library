...
class NSRecord_AccountingBook extends RequestAbstract
{
    ...
    */
    public static $schema = [
        'accountingBookSubsidiaries',// AccountingBookAccountingBookSubsidiariesCollection
        ...
        'subsidiariesString',      // string
        'subsidiary',              // SubsidiaryCollection
        'twosteprevenueallocation',// bool
        'unbilledreceivablegrouping',// string enum(SUBARRANGEMENTGROUP, ELEMENT, ARRANGEMENT)
    ];    
    ...
    * @return string json:accountingBook - Retrieved record 
    * @meta [default] nsError - Error response 
    */
