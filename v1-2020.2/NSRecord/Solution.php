<?php
class NSRecord_Solution extends RequestAbstract
{
   /**
    * [solution]
    ...
    */
    public static $schema = [
        ...
        'status',                  // string enum(UNAPPROVED, APPROVED)
        'title',                   // string
        'topics',                  // TopicCollection
        'userNotes',               // SolutionUserNotesCollection
    ];    
    ...
    * @return string json:solution - Retrieved record 
    * @meta [default] nsError - Error response 
    */
