<?php
class NSRecord_RevenueCommitmentReversal extends RequestAbstract
{
   /**
    ...
    */
    public static $schema = [
        ...
        'accountingBookDetail',    // RevenueCommitmentReversalAccountingBookDetailCollection
        ...
        'billingaddress',          // RevenueCommitmentReversalBillingaddress
        ...
        'item',                    // RevenueCommitmentReversalItemCollection
        ...
        'otherRefNum',             // string
        'partner',                 // Partner
        'partners',                // RevenueCommitmentReversalPartnersCollection
        ...
        'salesTeam',               // RevenueCommitmentReversalSalesTeamCollection
        ...
        'shipState',               // string
        'shipZip',                 // string
        'shippingAddress',         // RevenueCommitmentReversalShippingAddress
    ...
    * @return string json:revenueCommitmentReversal - Retrieved record 
    * @meta [default] nsError - Error response 
    */
