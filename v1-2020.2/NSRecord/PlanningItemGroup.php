<?php
class NSRecord_PlanningItemGroup extends RequestAbstract
{
   /**
    * [planningItemGroup]
    ...
    */
    public static $schema = [
        ...
        'name',                    // string
        'planningitems',           // PlanningItemGroupPlanningitemsCollection
    ...
    * @return string json:planningItemGroup - Retrieved record
    * @response [default] nsError - Error response
    */
