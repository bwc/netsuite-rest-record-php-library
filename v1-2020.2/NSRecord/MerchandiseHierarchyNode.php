<?php
class NSRecord_MerchandiseHierarchyNode extends RequestAbstract
{
   /**
    ...
    */
    public static $schema = [
        'description',             // string
        'externalId',              // string
        'hierarchyversions',       // MerchandiseHierarchyNodeHierarchyversionsCollection
        'id',                      // string
        'internalId',              // int
    ...
    * @return string json:merchandiseHierarchyNode - Retrieved record
    * @response [default] nsError - Error response
    */
