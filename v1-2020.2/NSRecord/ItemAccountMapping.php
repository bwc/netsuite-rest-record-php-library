...
class NSRecord_ItemAccountMapping extends RequestAbstract
{
    ...
    */
    public static $schema = [
        ...
        'externalId',              // string
        'id',                      // string
        'itemAccount',             // string enum(CUSTOMERRETURNVARIANCE, SCRAP, ACCOUNTSRECEIVABLE, PAYMENT, VENDORBILLQUANTITYVARIANCE, FXADJUSTMENTREVENUE, COGS, UNBUILDVARIANCE, PRODUCTIONQUANTITYVARIANCE, INTERCOCOGS)
    ...
    * @return string json:itemAccountMapping - Retrieved record 
    * @meta [default] nsError - Error response 
    */
