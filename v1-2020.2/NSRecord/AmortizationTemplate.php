<?php
class NSRecord_AmortizationTemplate extends RequestAbstract
{
   /**
    ...
    */
    public static $schema = [
        ...
        'name',                    // string
        'periodOffset',            // int
        'recogIntervalSrc',        // string enum(RECEIPTDATE, USERDEFINED, BETWEENBILLS, BETWEENBILLSRRDATE, SOREVRECDATES)
        'recurrence',              // AmortizationTemplateRecurrenceCollection
    ...
    * @return string json:amortizationTemplate - Retrieved record
    * @response [default] nsError - Error response
    */
