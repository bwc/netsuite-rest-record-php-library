<?php
class NSRecord_InventoryStatusChange extends RequestAbstract
{
   /**
    ...
    */
    public static $schema = [
        ...
        'externalId',              // string
        'id',                      // string
        'inventory',               // InventoryStatusChangeInventoryCollection
    ...
    * @return string json:inventoryStatusChange - Retrieved record
    * @response [default] nsError - Error response
    */
