<?php
class NSRecord_ItemSupplyPlan extends RequestAbstract
{
   /**
    * [itemSupplyPlan]
    ...
    */
    public static $schema = [
        ...
        'location',                // Location
        'memo',                    // string
        'order',                   // ItemSupplyPlanOrderCollection
        'planningmessage',         // ItemSupplyPlanPlanningmessageCollection
    ...
    * @return string json:itemSupplyPlan - Retrieved record
    * @response [default] nsError - Error response
    */
