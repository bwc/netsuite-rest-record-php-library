<?php
class NSRecord_ManufacturingRouting extends RequestAbstract
{
   /**
    ...
    */
    public static $schema = [
        ...
        'routingComponent',        // ManufacturingRoutingRoutingComponentCollection
        'routingStep',             // ManufacturingRoutingRoutingStepCollection
    ...
    * @return string json:manufacturingRouting - Retrieved record
    * @response [default] nsError - Error response
    */
