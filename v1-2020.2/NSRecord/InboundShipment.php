...
class NSRecord_InboundShipment extends RequestAbstract
{
    ...
    */
    public static $schema = [
        ...
        'externalId',              // string
        'id',                      // string
        'items',                   // InboundShipmentItemsCollection
        'landedCost',              // InboundShipmentLandedCostCollection
        ...
        'shipmentStatus',          // string enum(toBeShipped, inTransit, partiallyReceived, received, closed)
        'vesselNumber',            // string
    ];    
    ...
    * @return string json:inboundShipment - Retrieved record 
    * @meta [default] nsError - Error response 
    */
