<?php
class NSRecord_SubtotalItem extends RequestAbstract
{
   /**
    * [subtotalItem]
    ...
    */
    public static $schema = [
        ...
        'translations',            // SubtotalItemTranslationsCollection
        'userNotes',               // SubtotalItemUserNotesCollection
    ];    
    ...
    * @return string json:subtotalItem - Retrieved record 
    * @meta [default] nsError - Error response 
    */
