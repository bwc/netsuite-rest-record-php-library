<?php
class NSRecord_ItemGroup extends RequestAbstract
{
   /**
    * [itemGroup]
    ...
    */
    public static $schema = [
        ...
        'displayName',             // string
        'externalId',              // string
        'hierarchyversions',       // ItemGroupHierarchyversionsCollection
        'id',                      // string
        'includeChildren',         // bool
        'includeStartEndLines',    // bool
        ...
        'location',                // Location
        'member',                  // ItemGroupMemberCollection
        'parent',                  // ItemGroup
        'pf',                      // string
        'pi',                      // string
        'pr',                      // string
        ...
        'translations',            // ItemGroupTranslationsCollection
        'upcCode',                 // string
        'userNotes',               // ItemGroupUserNotesCollection
        'vendorName',              // string
    ];    
    ...
    * @return string json:itemGroup - Retrieved record
    * @response [default] nsError - Error response
    */
