<?php
class NSRecord_BillingRevenueEvent extends RequestAbstract
{
   /**
    * [billingRevenueEvent]
    ...
    */
    public static $schema = [
        'amount',                  // float
        'cumulativePercentComplete',// float
        'customForm',              // string enum(-10916, -10915, -10914, -20961, -10230, -893, -892, -410, -891, -770)
        'enddate',                 // string
        'eventType',               // NsResource
        'eventdate',               // string
        'eventpurpose',            // string enum(ACTUAL, FORECAST)
        'externalId',              // string
        'id',                      // string
        'links',                   // NsLink, [read_only]
        'projectRevenueRule',      // string
        'quantity',                // float
    ...
    * @return string json:billingRevenueEvent - Retrieved record 
    * @meta [default] nsError - Error response 
    */
