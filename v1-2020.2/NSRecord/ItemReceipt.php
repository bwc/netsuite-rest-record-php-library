<?php
class NSRecord_ItemReceipt extends RequestAbstract
{
   /**
    * [itemReceipt]
    ...
    */
    public static $schema = [
        'accountingBookDetail',    // ItemReceiptAccountingBookDetailCollection
        ...
        'isAdvBill',               // bool
        'isTransforming',          // bool
        'item',                    // ItemReceiptItemCollection
    ...
    * @return string json:itemReceipt - Retrieved record 
    * @meta [default] nsError - Error response 
    */
