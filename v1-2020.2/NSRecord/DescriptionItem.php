<?php
class NSRecord_DescriptionItem extends RequestAbstract
{
   /**
    * [descriptionItem]
    ...
    */
    public static $schema = [
        ...
        'translations',            // DescriptionItemTranslationsCollection
        'userNotes',               // DescriptionItemUserNotesCollection
    ];    
    ...
    * @return string json:descriptionItem - Retrieved record
    * @response [default] nsError - Error response
    */
