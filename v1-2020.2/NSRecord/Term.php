<?php
class NSRecord_Term extends RequestAbstract
{
   /**
    * [term]
    ...
    */
    public static $schema = [
        'dateDriven',              // bool
        'dayDiscountExpires',      // int
        'dayOfMonthNetDue',        // int
        'daysUntilExpiry',         // int
        'daysUntilNetDue',         // int
        'discountPercent',         // float
        'discountPercentDateDriven',// float
        'dueNextMonthIfWithinDays',// int
        'externalId',              // string
        'id',                      // string
        'installment',             // bool
        'isInactive',              // bool
        ...
        'name',                    // string
        'payTaxUpfront',           // bool
        'percentages',             // TermPercentagesCollection
        'preferred',               // bool
        'recurrenceCount',         // int
    ...
    * @return string json:term - Retrieved record 
    * @meta [default] nsError - Error response 
    */
