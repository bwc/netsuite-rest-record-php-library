<?php
class NSRecord_InventoryStatus extends RequestAbstract
{
   /**
    * [inventoryStatus]
    ...
    */
    public static $schema = [
        ...
        'inventoryavailforalloc',  // bool
        'isInactive',              // bool
        'links',                   // NsLink, [read_only]
        'name',                    // string
        'refName',                 // string, [read_only]
        'state',                   // string enum(A, D, I)
        'translations',            // InventoryStatusTranslationsCollection
    ];    
    ...
    * @return string json:inventoryStatus - Retrieved record 
    * @meta [default] nsError - Error response 
    */
