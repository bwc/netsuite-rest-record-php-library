...
class NSRecord_AssemblyItem extends RequestAbstract
{
    ...
    */
    public static $schema = [
        ...
        'accountingBookDetail',    // AssemblyItemAccountingBookDetailCollection
        'alternateDemandSourceItem',// AssemblyItem
        'amortizationPeriod',      // int
        'amortizationTemplate',    // AmortizationTemplate
        'assemblyBomLocation',     // AssemblyItemAssemblyBomLocationCollection
        ...
        'billOfMaterials',         // AssemblyItemBillOfMaterialsCollection
        'billPriceVarianceAcct',   // Account
        'billQtyVarianceAcct',     // Account
        'billingSchedule',         // BillingSchedule
        'binNumber',               // AssemblyItemBinNumberCollection
        'buildEntireAssembly',     // bool
        'buildTime',               // float
        ...
        'correlatedItems',         // AssemblyItemCorrelatedItemsCollection
        'cost',                    // float
        ...
        'effectiveBomControl',     // string enum(EFFECTIVE_DATE, REVISION_CONTROL)
        ...
        'hierarchyversions',       // AssemblyItemHierarchyversionsCollection
        'id',                      // string
        ...
        'itemVendor',              // AssemblyItemItemVendorCollection
        ...
        'location',                // Location
        'locations',               // AssemblyItemLocationsCollection
        'manufacturer',            // string
        ...
        'member',                  // AssemblyItemMemberCollection
        'metaTagHtml',             // string
        'minimumquantity',         // int
        ...
        'presentationItem',        // AssemblyItemPresentationItemCollection
        'price',                   // AssemblyItemPrice
        ...
        'siteCategory',            // AssemblyItemSiteCategoryCollection
        ...
        'translations',            // AssemblyItemTranslationsCollection
        ...
        'userNotes',               // AssemblyItemUserNotesCollection
    ...
    * @return string json:assemblyItem - Retrieved record 
    * @meta [default] nsError - Error response 
    */
    ...
    * @param string $replace           Names of sublists on this record. All lines on these sublists will be replaced with lines from input. Sublists not specified here will have lines added to record. Names are delimited by comma. (in query)
    * @param numeric $id [Required]    Internal identifier (in path)
    * @meta [204 No Content] workOrder - Transformed record 
    * @meta [default] nsError - Error response 
    */
    public function transformToWorkOrder($body, $xNetSuitePropertyNameValidation = null, $xNetSuitePropertyValueValidation = null, $replace = null, $id = null)
    {
        $parts = [];
