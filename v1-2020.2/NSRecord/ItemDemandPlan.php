<?php
class NSRecord_ItemDemandPlan extends RequestAbstract
{
   /**
    * [itemDemandPlan]
    ...
    */
    public static $schema = [
        ...
        'demandplandetail',        // ItemDemandPlanDemandplandetailCollection
        'demandplanid',            // string
        'demandplantype',          // string enum(FINAL, SYSTEMFORECAST)
        'endDate',                 // string
        'externalId',              // string
        'id',                      // string
        ...
        'location',                // Location
        'memo',                    // string
        'month',                   // string enum(11, 1, 12, 2, 3, 4, 5, 6, 7, 8)
        'projectionDuration',      // int
    ...
    * @return string json:itemDemandPlan - Retrieved record 
    * @meta [default] nsError - Error response 
    */
