...
class NSRecord_StatisticalJournalEntry extends RequestAbstract
{
    ...
    */
    public static $schema = [
        ...
        'accountingBookDetail',    // StatisticalJournalEntryAccountingBookDetailCollection
        ...
        'id',                      // string
        'isBaseCurrency',          // bool
        'isFromAmortization',      // bool
        'isReversal',              // bool
        'isbookspecific',          // bool
        'lastModifiedDate',        // string
        'line',                    // StatisticalJournalEntryLineCollection
    ...
    * @return string json:statisticalJournalEntry - Retrieved record 
    * @meta [default] nsError - Error response 
    */
