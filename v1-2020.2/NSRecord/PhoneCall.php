<?php
class NSRecord_PhoneCall extends RequestAbstract
{
   /**
    * [phoneCall]
    ...
    */
    public static $schema = [
        ...
        'startDate',               // string
        'startTime',               // string
        'status',                  // string enum(SCHEDULED, FAILED, COMPLETE)
        'supportCase',             // SupportCase
        'timedEvent',              // bool
        'timezone',                // string
        'title',                   // string
        'transaction',             // NsResource
        'userNotes',               // PhoneCallUserNotesCollection
    ];    
    ...
    * @return string json:phoneCall - Retrieved record
    * @response [default] nsError - Error response
    */
