<?php
class NSRecord_Deposit extends RequestAbstract
{
   /**
    * [deposit]
    ...
    */
    public static $schema = [
        'account',                 // Account
        'accountingBookDetail',    // DepositAccountingBookDetailCollection
        'cashback',                // DepositCashbackCollection
        ...
        'location',                // Location
        'memo',                    // string
        'other',                   // DepositOtherCollection
        'payment',                 // DepositPaymentCollection
    ...
    * @return string json:deposit - Retrieved record 
    * @meta [default] nsError - Error response 
    */
