<?php
class NSRecord_SupplyChangeOrder extends RequestAbstract
{
   /**
    * [supplyChangeOrder]
    ...
    */
    public static $schema = [
        'approvalstatus',          // string enum(17, 18, 19)
        'changeaction',            // string enum(RESCHEDULE_IN, CANCEL, RESCHEDULE_OUT)
        ...
        'status',                  // string enum(PENDING_APPROVAL, RELEASED, IMPLEMENTED, REJECTED)
    ...
    * @return string json:supplyChangeOrder - Retrieved record
    * @response [default] nsError - Error response
    */
