...
class NSRecord_CreditCardCharge extends RequestAbstract
{
    ...
    */
    public static $schema = [
        'account',                 // Account
        'accountingBookDetail',    // CreditCardChargeAccountingBookDetailCollection
        'balance',                 // float
        ...
        'expacct',                 // int
        'expacctname',             // string
        'expense',                 // CreditCardChargeExpenseCollection
        'externalId',              // string
        'grossTotal',              // float
        'id',                      // string
        ...
        'isAdvBill',               // bool
        'isTransforming',          // bool
        'item',                    // CreditCardChargeItemCollection
        ...
        'taxDetails',              // CreditCardChargeTaxDetailsCollection
    ...
    * @return string json:creditCardCharge - Retrieved record 
    * @meta [default] nsError - Error response 
    */
