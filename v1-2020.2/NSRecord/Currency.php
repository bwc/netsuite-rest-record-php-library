...
class NSRecord_Currency extends RequestAbstract
{
    ...
    */
    public static $schema = [
        ...
        'externalId',              // string
        'formatSample',            // string
        'fxRateUpdateTimezone',    // string enum(1, 2, 3, 4)
        'id',                      // string
        'includeInFxRateUpdates',  // bool
        'isAnchorCurrency',        // bool
        'isBaseCurrency',          // bool
        'isInactive',              // bool
        'lastModifiedDate',        // string
        'links',                   // NsLink, [read_only]
        'locale',                  // string enum(it_CH, en_TC, af_ZA, es_EA, es_EC, pt_BR, en_CY, fr_LU, nl_AN, es_UY)
        'name',                    // string
    ...
    * @return string json:currency - Retrieved record 
    * @meta [default] nsError - Error response 
    */
