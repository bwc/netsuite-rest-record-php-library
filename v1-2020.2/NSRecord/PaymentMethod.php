<?php
class NSRecord_PaymentMethod extends RequestAbstract
{
   /**
    * [paymentMethod]
    ...
    */
    public static $schema = [
        ...
        'methodType',              // string enum(11, 1, 12, 2, 3, 4, 5, 6, 7, 8)
        'name',                    // string
        'paypal',                  // bool
        'refName',                 // string, [read_only]
        'tname',                   // string
        'undepFunds',              // bool
        'visuals',                 // PaymentMethodVisualsCollection
    ];    
    ...
    * @return string json:paymentMethod - Retrieved record
    * @response [default] nsError - Error response
    */
