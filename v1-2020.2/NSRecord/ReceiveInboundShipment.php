<?php
class NSRecord_ReceiveInboundShipment extends RequestAbstract
{
   /**
    ...
    */
    public static $schema = [
        ...
        'receiveItems',            // ReceiveInboundShipmentReceiveItemsCollection
    ...
    * @return string json:receiveInboundShipment - Retrieved record 
    * @meta [default] nsError - Error response 
    */
