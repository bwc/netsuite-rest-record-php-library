<?php
class NSRecord_TaxType extends RequestAbstract
{
   /**
    * [taxType]
    ...
    */
    public static $schema = [
        ...
        'moss',                    // bool
        'name',                    // string
        'nexusAccounts',           // TaxTypeNexusAccountsCollection
        'nexusesTax',              // TaxTypeNexusesTaxCollection
        'postToItemCost',          // bool
    ...
    * @return string json:taxType - Retrieved record
    * @response [default] nsError - Error response
    */
