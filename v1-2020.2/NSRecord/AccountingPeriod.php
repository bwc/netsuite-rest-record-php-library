...
class NSRecord_AccountingPeriod extends RequestAbstract
{
    ...
    */
    public static $schema = [
        ...
        'fiscalCalendars',         // AccountingPeriodFiscalCalendarsCollection
        'id',                      // string
        'isAdjust',                // bool
        'isInactive',              // bool
        'isPosting',               // bool
        ...
        'payrollLocked',           // bool
        'perBookPeriodClosing',    // AccountingPeriodPerBookPeriodClosingCollection
        'periodName',              // string
        'prependToAllBooks',       // bool
        'refName',                 // string, [read_only]
        'startDate',               // string
        'userNotes',               // AccountingPeriodUserNotesCollection
    ];    
    ...
    * @return string json:accountingPeriod - Retrieved record 
    * @meta [default] nsError - Error response 
    */
