<?php
class NSRecord_ProjectExpenseType extends RequestAbstract
{
   /**
    * [projectExpenseType]
    ...
    */
    public static $schema = [
        ...
        'translation',             // ProjectExpenseTypeTranslationCollection
    ];    
    ...
    * @return string json:projectExpenseType - Retrieved record
    * @response [default] nsError - Error response
    */
