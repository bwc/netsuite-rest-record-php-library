<?php
class NSRecord_SupplyChainSnapshot extends RequestAbstract
{
   /**
    * [supplyChainSnapshot]
    ...
    */
    public static $schema = [
        ...
        'refresh',                 // bool
        'replenishmentmethod',     // string enum(TIME_PHASED, REORDER_POINT, MRP)
        'stockunit',               // string
        'supplychainsnapshotdetails',// SupplyChainSnapshotSupplychainsnapshotdetailsCollection
    ];    
    ...
    * @return string json:supplyChainSnapshot - Retrieved record
    * @response [default] nsError - Error response
    */
