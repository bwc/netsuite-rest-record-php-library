...
class NSRecord_ExpenseCategory extends RequestAbstract
{
    ...
    */
    public static $schema = [
        ...
        'description',             // string
        'expenseacct',             // Account
        'expenseitem',             // InventoryItem|ServiceItem|OtherChargeItem|AssemblyItem|KitItem|NsResource|DiscountItem|MarkupItem|SubtotalItem|DescriptionItem|PaymentItem|SalesTaxItem|TaxGroup|ShipItem|DownloadItem|GiftCertificateItem|SubscriptionPlan|NonInventorySaleItem|NonInventoryResaleItem|NonInventoryPurchaseItem
        'externalId',              // string
        'id',                      // string
        'isinactive',              // bool
        'links',                   // NsLink, [read_only]
        'name',                    // string
        'personalcorporatecardexpense',// bool
        'raterequired',            // bool
        'rates',                   // ExpenseCategoryRatesCollection
        'refName',                 // string, [read_only]
        'subsidiary',              // SubsidiaryCollection
        'translations',            // ExpenseCategoryTranslationsCollection
    ];    
