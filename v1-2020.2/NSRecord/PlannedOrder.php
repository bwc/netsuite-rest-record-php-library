...
class NSRecord_PlannedOrder extends RequestAbstract
{
    ...
    */
    public static $schema = [
        ...
        'location',                // Location
        'memo',                    // string
        'plannedorderstatus',      // string enum(FIRMED, RELEASED, IMPLEMENTED, PLANNED)
        'planningordertype',       // string
        'quantity',                // string
        'refName',                 // string, [read_only]
        'released',                // bool
        'sourceitemlocation',      // int
        'sourcelocation',          // Location
        'startdate',               // string
        'supplyplandefinition',    // SupplyPlanDefinition
        'supplyplanningrun',       // int
        'transactioncreated',      // NsResource
        'transactionlinecreated',  // string
    ...
    * @return string json:plannedOrder - Retrieved record
    * @response [default] nsError - Error response
    */
